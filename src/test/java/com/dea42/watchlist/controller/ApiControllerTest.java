...
public class ApiControllerTest extends MockBase {
	...
	public void testGetAllNetworkss() throws Exception {
		...
		this.mockMvc.perform(get("/api/networkss").with(getMockTestAdmin())).andExpect(status().isOk())
				.andExpect(content()
						.string(containsString("ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890abcdefghijklmnopqrstuvwzy")))
				...
				.andExpect(
						content().string(containsString("ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890abcdefghijklmnopqrst")))
				...
				.andExpect(content()
						.string(containsString("ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890abcdefghijklmnopqrstuvwz")))
				...
				.andExpect(content()
						.string(containsString("ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890abcdefghijklmnopqrstuvwzyz")))
	...
	public void testGetAllShowss() throws Exception {
		...
		this.mockMvc.perform(get("/api/showss").with(getMockTestAdmin())).andExpect(status().isOk())
				.andExpect(content().string(containsString("A"))).andExpect(content().string(containsString("imdb")))
				.andExpect(content()
						.string(containsString("ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890abcdefghijklmnopqrstuvwzy")))
				.andExpect(content().string(containsString("commentlink")))
				.andExpect(content()
				...
				.andExpect(content()
						.string(containsString("ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890abcdefghijklmnopqrstuvwzy")))
				.andExpect(content().string(containsString("status"))).andExpect(content().string(containsString("id")))
				...
				.andExpect(content()
						.string(containsString("ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890abcdefghijklmnopqrstuvw")))
				.andExpect(content().string(containsString("epguidesshownamelink")))
				.andExpect(content().string(containsString("ABC"))).andExpect(content().string(containsString("ota")));
	}
	...
	public void testGetAllRoamiosps() throws Exception {
		...
		this.mockMvc.perform(get("/api/roamiosps").with(getMockTestAdmin())).andExpect(status().isOk())
				...
				.andExpect(content().string(containsString("id"))).andExpect(content().string(containsString("ABCDEF")))
				...
				.andExpect(content().string(containsString("show"))).andExpect(content().string(containsString("num")))
	...
	public void testGetAllCablecards() throws Exception {
		...
		this.mockMvc.perform(get("/api/cablecards").with(getMockTestAdmin())).andExpect(status().isOk())
				.andExpect(content().string(containsString("ABC")))
				.andExpect(content().string(containsString("receiving")))
				.andExpect(content().string(containsString("dt"))).andExpect(content().string(containsString("id")))
				.andExpect(content().string(containsString("innpl"))).andExpect(content().string(containsString("AB")))
				...
				.andExpect(content().string(containsString("colh"))).andExpect(content().string(containsString("hd")))
				.andExpect(content().string(containsString("ABCDEFGHIJKL")))
	...
	public void testGetAllRoamionpls() throws Exception {
		...
		this.mockMvc.perform(get("/api/roamionpls").with(getMockTestAdmin())).andExpect(status().isOk())
				.andExpect(content().string(containsString("id")))
				...
				.andExpect(content().string(containsString("show"))).andExpect(content().string(containsString("ABCD")))
	...
	public void testGetAllOtas() throws Exception {
		...
		this.mockMvc.perform(get("/api/otas").with(getMockTestAdmin())).andExpect(status().isOk())
				.andExpect(content().string(containsString("subchan")))
				.andExpect(content().string(containsString("ABCDE"))).andExpect(content().string(containsString("rez")))
				.andExpect(content().string(containsString("id")))
				...
				.andExpect(content().string(containsString("AB"))).andExpect(content().string(containsString("lang")))
				.andExpect(content().string(containsString("chan"))).andExpect(content().string(containsString("ABC")))
	...
	public void testGetAllRoamiotodos() throws Exception {
		...
		this.mockMvc.perform(get("/api/roamiotodos").with(getMockTestAdmin())).andExpect(status().isOk())
				.andExpect(content().string(containsString("id"))).andExpect(content().string(containsString("ep")))
				.andExpect(content().string(containsString("date")))
				.andExpect(content().string(containsString("ABCDEFGHIJKLMNOP")))
				.andExpect(content().string(containsString("channel")))
				.andExpect(content()
